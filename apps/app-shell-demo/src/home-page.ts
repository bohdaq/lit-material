    ...
    return html`
      <lit-material-card variant="elevated">
        ...
        <p>
          ...
          tabs above, or click below — every navigation is a client-side route change, not a full page
          reload (open devtools' Network tab and watch).
        </p>
        <p>
        ...
        <lit-material-button variant="tonal" href="/counter">Go to the counter →</lit-material-button>
      </lit-material-card>
    `;
  }
}
